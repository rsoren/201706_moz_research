---
title: "PEER_03_analyze_individual_data"
...
path <- "C:/Users/rsoren/Documents/prog/projects/201706_moz_research/"
dat_in <- read.csv(paste0(path, "_data/seguimento_c_exposta.csv"))
...
write.csv(new_dat, 
  file = paste0(path, "_data/newdata_aggregated_from_individual.csv"),
  row.names = FALSE
)
